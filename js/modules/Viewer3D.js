...
export default class Viewer3D {
  ...
  constructor(containerId) {
    ...
    this._originMode = 'start'; // 'start' or 'end'
    this._grid = null;
    this._axes = null;
  ...
  _initHelpers() {
    this._grid = new THREE.GridHelper(GRID_SIZE * GRID_DIVISIONS, GRID_DIVISIONS, 0x888888, 0x444444);
  ...
  updateRoute(points) {
    ...
    // Store positions for origin toggle
  ...
  /** Moves grid and axes to the selected origin point */
  _updateHelperOrigin() {
  ...
  /**
   * Toggles origin between start and end point
   * @returns {'start'|'end'} The new origin mode
   */
  toggleOrigin() {
